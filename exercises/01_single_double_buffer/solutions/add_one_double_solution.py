...
#
# SOLUTION -- Double-buffer add-one design for the XDNA2 NPU (Strix).
#
# The only change from add_one_single.py is setting ObjectFIFO depth=2
# on both of_in and of_out to enable double (ping-pong) buffering.
#
# Usage:
#   python3 add_one_double_solution.py -i1s 65536 -os 65536 [-t TRACE_SIZE]
#
# =========================================================================
import numpy as np
import argparse
...
def add_one_double(in1_size, out_size, trace_size):
    ...
    # ------------------------------------------------------------------
    # 2. ObjectFIFOs -- depth=2 enables double buffering
    # ------------------------------------------------------------------
...
if __name__ == "__main__":
    p = argparse.ArgumentParser(
        description="Double-buffer add-one for XDNA2 NPU (SOLUTION)"
    )
    p.add_argument(
