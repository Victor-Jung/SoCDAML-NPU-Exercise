...
> 4. How much additional L1 memory does the double buffer use compared to single buffer?  *Hint: each ObjectFIFO allocates `depth × chunk_size` bytes on both producer and consumer sides.* TODO Make this less
